        ...
        @auth
            @if(!$sudah_lapor_hari_ini)
                <div class="p-4 mb-4 text-sm text-yellow-800 rounded-lg bg-yellow-50 dark:bg-gray-800 dark:text-yellow-300" role="alert">
                    <span class="font-medium"><x-lucide-alert-circle class="inline w-5 h-5 mr-1" /> Sepertinya kamu belum lapor hari ini. Yuk mulai setor laporan harian <a href="{{ route('laporan.create') }}" class="text-[#007dd9]">disini</a></span>
                </div>
            @endif
        @endauth
