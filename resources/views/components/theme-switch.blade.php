...
>
    ...
    >
        ...
        <svg x-show="!darkMode" xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-yellow-500" viewBox="0 0 20 20" fill="currentColor">
        ...
        <svg x-show="darkMode" xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-indigo-200" viewBox="0 0 20 20" fill="currentColor">
