        ...
        <form action="{{ route('laporan.store') }}" method="POST">
            ...
            @if ($is_wanita)
                ...
                <div class="mt-8">
                    ...
                    <x-select-input id="is_haid" class="block mt-1 w-full" type="text" name="is_haid" :value="old('is_haid')" :options="$options" :is_include_empty="1" :required="1" />
            ...
            <div id="container-laporan-form" @if ($is_wanita) style="display: none;" @endif>
                ...
                <div class="mt-8">
                    ...
                    <x-select-input id="sholat_berjamaah" class="block mt-1 w-full" type="text" name="sholat_berjamaah" :value="old('sholat_berjamaah')" :options="$options" :required="1" />
                ...
                <div class="mt-8">
                    ...
                    <x-select-input id="mengaji" class="block mt-1 w-full" type="text" name="mengaji" :value="old('mengaji')" :options="$options" :required="1" />
                ...
                <div class="mt-8">
                    ...
                    <x-select-input id="infaq" class="block mt-1 w-full" type="text" name="infaq" :value="old('infaq')" :options="$options" :required="1" />
                ...
                <div class="mt-8">
                    ...
                    <x-select-input id="tarawih_berjamaah" class="block mt-1 w-full" type="text" name="tarawih_berjamaah" :value="old('tarawih_berjamaah')" :options="$options" :required="1" />
                ...
                <div class="mt-8">
                    ...
                    <x-select-input id="dhuha" class="block mt-1 w-full" type="text" name="dhuha" :value="old('dhuha')" :options="$options" :required="1" />
                ...
                <div class="mt-8">
                    ...
                    <x-select-input id="kajian" class="block mt-1 w-full" type="text" name="kajian" :value="old('kajian')" :options="$options" :required="1" />
                ...
                <div class="mt-8">
                    ...
                    <x-select-input id="tahajjud" class="block mt-1 w-full" type="text" name="tahajjud" :value="old('tahajjud')" :options="$options" :required="1" />
            ...
            @if ($is_wanita)
                <div id="container-laporan-haid-form" style="display: none;">
                    ...
                    <div class="mt-8">
                        ...
                        <x-select-input id="haid_kajian" class="block mt-1 w-full" type="text" name="haid_kajian" :value="old('haid_kajian')" :options="$options" :required="1" />
                    ...
                    <div class="mt-8">
                        ...
                        <x-select-input id="haid_zikir" class="block mt-1 w-full" type="text" name="haid_zikir" :value="old('haid_zikir')" :options="$options" :required="1" />
                    ...
                    <div class="mt-8">
                        ...
                        <x-select-input id="haid_memberi_makanan_iftar" class="block mt-1 w-full" type="text" name="haid_memberi_makanan_iftar" :value="old('haid_zikir')" :options="$options" :required="1" />
                    ...
                    <div class="mt-8">
                        ...
                        <x-select-input id="haid_mendengar_alquran" class="block mt-1 w-full" type="text" name="haid_mendengar_alquran" :value="old('haid_mendengar_alquran')" :options="$options" :required="1" />
                    ...
                    <div class="mt-8">
                        ...
                        <x-select-input id="haid_infaq" class="block mt-1 w-full" type="text" name="haid_infaq" :value="old('haid_infaq')" :options="$options" :required="1" />
                    ...
                    <div class="mt-8">
                        ...
                        <x-select-input id="haid_membaca_surah_nabawiyah" class="block mt-1 w-full" type="text" name="haid_membaca_surah_nabawiyah" :value="old('haid_membaca_surah_nabawiyah')" :options="$options" :required="1" />
                    ...
                    <div class="mt-8">
                        ...
                        <x-select-input id="haid_membaca_hadist" class="block mt-1 w-full" type="text" name="haid_membaca_hadist" :value="old('haid_membaca_hadist')" :options="$options" :required="1" />
